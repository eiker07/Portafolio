      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          >
            ...
            <img
              src="https://media2.giphy.com/media/v1.Y2lkPTc5MGI3NjExNTBremNuY3FycG1wOWM0YWN1cjBqeXUybnNkdzV6ZDJnZ2g5dTFkaSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/W9n5Ai83YXNkhQ1iXm/giphy.webp"
              alt="Programming"
